const quotesOnline = ['"Focus on being productive instead of busy." --Tim Ferriss',
  ...
  if (request.isTimerOver) {
    ...
    if (elementExist.length !== 0) {
      ...
      if (typeof init === "undefined") {
        ...
        document.getElementById("giveUpBtn").addEventListener("click", displayPopup);
        document.getElementById("cancelBtn").addEventListener("click", clickedCancel);
...
function displayPopup() {
  document.getElementById("changeBackground").style.backgroundColor = "rgba(0, 0, 0, 1)";
...
function clickedCancel() {
  ...
  document.getElementById("changeBackground").style.backgroundColor = "rgba(0, 0, 0, 0.867)";
